...
export const ROOMS = {
  ...
  buzzer: R('buzzer', 'ch2', '멜로디 연주단', '🔊', 'tone · 주파수', '부저로 멜로디 연주', '🎵 리듬 메달'),
  rgb:    R('rgb', 'ch2', '무지개 물감놀이', '🌈', 'PWM 색 혼합', '색을 섞어 정답 색 만들기', '🌈 무지개 메달'),
  ...
  cds:    R('cds', 'ch2', '손그림자 마술', '🔆', '아날로그 입력(빛)', '조도센서로 빛 가리기 반응', '🔆 햇살 메달'),
...
export const CHAPTERS = [
  ...
  { id: 'ch2', no: 2, label: '기초의 전당', short: '기초의 전당', act: '센서 개별 체험', icon: '🏛️',
    rooms: ['led', 'buzzer', 'rgb', 'seg', 'pot', 'button', 'cds', 'servo'] },
