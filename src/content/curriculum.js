...
export const ROOMS = {
  ...
  rgb:   R('rgb', 'ch2', 'RGB LED', '🌈', '색 혼합(PWM 3채널)', '색 암호등', '색 코드 조각'),
  buzzer:R('buzzer', 'ch2', '부저', '🔊', 'tone · 주파수', '경보 해제', '정적 회복'),
  seg:   R('seg', 'ch2', '7세그먼트', '🔢', '세그먼트 제어', '봉인 카운트다운', '출구 일부 개방'),
  ...
  keypad:R('keypad', 'ch2', '키패드', '🔢', '매트릭스 입력', '출입문 비번', '출입문 해제'),
  // CH3 · 보안 돌파 (응용)
